(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))t(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&t(i)}).observe(document,{childList:!0,subtree:!0});function o(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function t(e){if(e.ep)return;e.ep=!0;const s=o(e);fetch(e.href,s)}})();const hamburger=document.querySelector(".hamburger"),navMenu=document.querySelector(".page__navbar-items");function toggleHamburger(){hamburger.classList.toggle("active"),navMenu.classList.toggle("active")}hamburger.addEventListener("click",toggleHamburger);navMenu.addEventListener("click",toggleHamburger);const observer=new IntersectionObserver(r=>{r.forEach(n=>{n.isIntersecting&&(n.target.classList.add("animate"),observer.unobserve(n.target))})},{threshold:.7});document.querySelectorAll(".rectangle").forEach(r=>{observer.observe(r)});window.addEventListener("scroll",()=>{const r=document.querySelector(".page__header"),n=document.querySelector(".page__navbar");window.scrollY>24?r.classList.add("active"):r.classList.remove("active"),window.scrollY>650?n.classList.add("active"):n.classList.remove("active")});const testimonials=document.querySelectorAll(".testimonial");let range=[0,1,2];const totalTestimonials=testimonials.length;function showTestimonial(r){testimonials.forEach((n,o)=>{r.includes(o)?(n.classList.remove("testimonial--hidden"),o!==r[1]?n.classList.add("testimonial--secondary"):n.classList.remove("testimonial--secondary")):n.classList.add("testimonial--hidden"),n.style.order=range.indexOf(o)})}function updateRange(r){r<0?r=totalTestimonials-1:r>=totalTestimonials&&(r=0);let n=[0,0,0];return n[1]=r,n[0]=r-1,n[2]=r+1,r<=0?n[0]=totalTestimonials-1:r>=totalTestimonials-1&&(n[2]=0),n}function moveTestimonialsBack(){let r=range[1]-1;range=updateRange(r),showTestimonial(range)}function moveTestimonialsForward(){let r=range[1]+1;range=updateRange(r),showTestimonial(range)}document.addEventListener("DOMContentLoaded",()=>{showTestimonial(range)});const buttonRight=document.querySelector(".testimonials__button--right"),buttonLeft=document.querySelector(".testimonials__button--left");buttonRight.addEventListener("click",moveTestimonialsForward);buttonLeft.addEventListener("click",moveTestimonialsBack);function getDefaultExportFromCjs(r){return r&&r.__esModule&&Object.prototype.hasOwnProperty.call(r,"default")?r.default:r}var kursor$1={exports:{}};/*!
  * Kursor v0.1.5
  * Forged by Luis Daniel Rovira
  * Released under the MIT License.
  */var kursor=kursor$1.exports,hasRequiredKursor;function requireKursor(){return hasRequiredKursor||(hasRequiredKursor=1,function(module,exports){(function(n,o){module.exports=o()})(typeof self<"u"?self:kursor,function(){return function(r){var n={};function o(t){if(n[t])return n[t].exports;var e=n[t]={i:t,l:!1,exports:{}};return r[t].call(e.exports,e,e.exports,o),e.l=!0,e.exports}return o.m=r,o.c=n,o.d=function(t,e,s){o.o(t,e)||Object.defineProperty(t,e,{enumerable:!0,get:s})},o.r=function(t){typeof Symbol<"u"&&Symbol.toStringTag&&Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(t,"__esModule",{value:!0})},o.t=function(t,e){if(e&1&&(t=o(t)),e&8||e&4&&typeof t=="object"&&t&&t.__esModule)return t;var s=Object.create(null);if(o.r(s),Object.defineProperty(s,"default",{enumerable:!0,value:t}),e&2&&typeof t!="string")for(var i in t)o.d(s,i,(function(a){return t[a]}).bind(null,i));return s},o.n=function(t){var e=t&&t.__esModule?function(){return t.default}:function(){return t};return o.d(e,"a",e),e},o.o=function(t,e){return Object.prototype.hasOwnProperty.call(t,e)},o.p="/dist/",o(o.s="./src/index.js")}({"./src/index.js":function(module,exports,__webpack_require__){eval(`
...
//# sourceURL=webpack://kursor/./src/utils/index.js?`)}})})}(kursor$1)),kursor$1.exports}var kursorExports=requireKursor();const Kursor=getDefaultExportFromCjs(kursorExports);new Kursor({type:5,removeDefaultCursor:!1,color:"#1557ff"});
